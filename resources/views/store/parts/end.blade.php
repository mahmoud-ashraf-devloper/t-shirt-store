{{--   
<div class="fixed top-20 right-6 z-99">
...
<script src="{{ asset('site-assets/plugins/modernizr-3.5.0.min.js') }}"></script>
<script src="{{ asset('site-assets/plugins/jquery-3.5.1.min.js') }}"></script>
<script src="{{ asset('site-assets/plugins/owl-carousel/owl.carousel.min.js') }}"></script>
